...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('phase2_max_lin', default_value='0.15'),
        DeclareLaunchArgument('phase2_max_ang', default_value='0.6'),
        DeclareLaunchArgument('phase2_ff_gain_ang', default_value='0.0'),
        DeclareLaunchArgument('phase2_ff_gain_lin', default_value='0.0'),
        DeclareLaunchArgument('lidar_safety_stop_distance', default_value='0.6'),
        DeclareLaunchArgument('lidar_avoid_trigger_distance', default_value='0.9'),
    ...
    controller_node = Node(
        ...
        parameters=[{
            ...
            'phase2_ff_gain_ang': LaunchConfiguration('phase2_ff_gain_ang'),
            'phase2_ff_gain_lin': LaunchConfiguration('phase2_ff_gain_lin'),
            'lidar_safety_stop_distance': LaunchConfiguration('lidar_safety_stop_distance'),
            'lidar_avoid_trigger_distance': LaunchConfiguration('lidar_avoid_trigger_distance'),
